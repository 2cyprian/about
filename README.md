...
- **Highlights:** Property CRUD, JWT auth, image uploads, advanced search & filter
- 🔗 [View Project](https://cyprian-tekisalama.netlify.app/projects)
...
- **Highlights:** JWT authentication, real-time updates, multi-agency database schema
- 🔗 [View Project](https://cyprian-tekisalama.netlify.app/projects)
...
- **Stack:** PHP · MariaDB · Nginx · Certbot · Linux VPS
- **Highlights:** Domain DNS config, SSL via Certbot, MariaDB setup, Nginx reverse proxy
- 🔗 [View Project](https://cyprian-tekisalama.netlify.app/projects)
...
- **Stack:** React · Vite · Docker · Nginx · Certbot · Linux VPS
- **Highlights:** Automated SSL renewal, zero-downtime redeployment, full on-site IT support
- 🔗 [View Project](https://cyprian-tekisalama.netlify.app/projects)
...
- **Highlights:** SMOTE for imbalanced data, Precision/Recall/F1 evaluation, business-focused output
...
- **Stack:** Python · XGBoost · SQL · Streamlit
- **Highlights:** ARIMA + XGBoost forecasting, interactive dashboard, anomaly flagging
...
Front-End Developer Intern @ Subcode            Nov 2025 – Present
Field Survey Intern        @ Elipse Telecom     Late 2025 – 2026
IT Support Technician      @ LaptopMD           2024 – Present
Web Developer (Contract)   @ Brebs Insight      Jan – Mar 2025
Front-End Developer Intern @ PesaLock           Aug – Oct 2024
IT Support Intern          @ Tarime Town Council Aug – Oct 2023
```
...
[![Portfolio](https://img.shields.io/badge/Portfolio-1A3A5C?style=for-the-badge&logo=firefox&logoColor=white)](https://cyprian-tekisalama.netli<!-- HEADER -->
<div align="center">
